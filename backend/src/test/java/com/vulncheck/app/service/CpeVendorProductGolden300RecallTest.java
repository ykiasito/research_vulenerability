...
@Disabled("Post-item360-Step2-sync remeasurement (2026-09-06) against the real dev DB -- CPE "
        ...
        + "the pre-sync baseline's 62/68 = 0.9118), matching master's own 64/68 recorded by "
        + "Backlog299CpeRankingGolden300RecallTest for this same vendor:product metric over the "
        + "identical 68-row IDENTIFIED_CPE denominator (that class lists the identical four mismatch "
        + "rows below; CpeVendorProductGolden300RecallTest itself exists only on this closed-mode "
        + "branch, with no master counterpart): the sibling-product mismatches (VirtualBox and "
        + "Microsoft Visual Studio) are now resolved "

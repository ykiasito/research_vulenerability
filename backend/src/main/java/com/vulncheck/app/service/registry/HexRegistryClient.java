...
/**
 * Stage1 Tier1 lookup against the local Hex (Erlang/Elixir) registry mirror.
 * https://hex.pm/api
 *
 ...
 * or the {@code app.closed-mode.hex-mirror-enabled} flag was off) has been removed outright —
 ...
 * same as the live path's own not-found case used to be. See {@code HexMirrorSyncService} for the
 * writer side. Same shape as {@link CratesIoRegistryClient}/{@link RubyGemsRegistryClient}.
 */
@Component

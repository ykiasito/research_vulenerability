...
/**
 * Stage1 Tier1 lookup against the local crates.io (Rust) registry mirror.
 ...
 * or the {@code app.closed-mode.crates-io-mirror-enabled} flag was off) has been removed outright —
 ...
 * same as the live path's own not-found case used to be. See {@code CratesIoMirrorSyncService} for
 * the writer side.
 */
@Component

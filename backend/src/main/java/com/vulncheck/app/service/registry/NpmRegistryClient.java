...
/**
 * Stage1 Tier1 lookup against the local npm registry mirror.
 ...
 * or the {@code app.closed-mode.npm-mirror-enabled} flag was off) has been removed outright —
 ...
 * same as the live path's own not-found case used to be. See {@code NpmMirrorSyncService} for the
 * writer side.
 */
@Component

...
- [THIRD_PARTY_DATA_ATTRIBUTION.md](./THIRD_PARTY_DATA_ATTRIBUTION.md) — ミラーしている第三者脆弱性データソース(NVD/CVE.org/GHSA/OSV/CSAF Red Hat/CSAF Siemens)のライセンスと、商用利用時に必要な帰属表示義務の一覧。
